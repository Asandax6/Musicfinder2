...
Future<bool> setActiveAlbum(
    int index, String name, String art, int nbre) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
...
Future<bool> setActiveArtist(
    int index, String name, int nbreAlbum, int nbreTracks) async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
